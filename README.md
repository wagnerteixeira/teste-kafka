...
- [Producer built with .Net Core with SSL auth](./producer)
- [Consumer built with .Net Core with SSL auth](./consumer)
- [Simple Broker, just kafka and zookeper](./kafka-broker)
